		    ...
		    <div class="col-lg-4 col-sm-6 portfolio-item">
		        <div class="card h-100 ">
			        ...
			        <div class="card-footer bg-transparent">
			        	...
			        	?>
						<a href="javascript:void(0)" class="btn btn-secondary btn-block addtocart" data-id="<?=$id;?>" data-name="<?=$name;?>" data-codeno="<?=$codeno;?>" data-photo="<?=$photo;?>" data-price="<?=$price;?>" data-discount="<?=$discount;?>" style="background-color: #673AB7; border-color: #673AB7"> 
						...
						<span class="d-inline-block" tabindex="0" data-toggle="tooltip" title="If you want to order you must Sign In FIRST!!">
							<a href="login" class="btn btn-primary" data-toggle="tooltip" data-placement="top" title="Tooltip on top" style="background-color: #673AB7; border-color: #673AB7">
							  Add To Cart
							</a>
